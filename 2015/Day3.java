...
public class Day3 {
    ...
    int xPos = 0, yPos = 0;
    int xPosRobo = 0, yPosRobo = 0;
    ArrayList<Tuple<Integer, Integer>> houses = new ArrayList<>();

    public Day3() {
        char[] chars = input.toCharArray();

        houses.add(new Tuple<Integer, Integer>(0, 0));
        ...
        for (char chr : chars) {
            ...
            Tuple<Integer, Integer> pos = new Tuple<Integer, Integer>(roboTurn ? xPosRobo : xPos,
                    roboTurn ? yPosRobo : yPos);
